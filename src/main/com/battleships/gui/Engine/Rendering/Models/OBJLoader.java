    ...
    public static Mesh loadObjModel(String fileName){
        ...
        try {
            while (true){
                ...
                }else if(line.startsWith("usemt")){   //check if line is material --> following lines now show which vertex,texture and normal data go together, so all data has been read
