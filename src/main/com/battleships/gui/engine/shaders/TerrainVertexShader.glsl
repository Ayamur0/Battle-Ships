...
void main(){
    ...
    pass_textureCoords = textureCoords * 40.0; //pass textureCoords to fragment shader multiply with 40 to get texture Coords outside terrain texture, so textured gets tiled over terrain instad of stretched
