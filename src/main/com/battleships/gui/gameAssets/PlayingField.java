...
//
//        this.ball = new Entity(loader.loadModelFromOBJ("cannonball", "cannonball.png", 10, 1), new Vector3f(), new Vector3f(), 1);
...
//        if(cannonball.getDestinationGrid() == OWNFIELD) {
//            playHitEffect(cannonball.getDestination());
//            if(!shipHit) {
//                placeMarker(shipHit, cannonball.getDestinationCell(), cannonball.getDestinationGrid());
//                waterSplash.setPosition(cannonball.getDestination().x, -3, cannonball.getDestination().y);
//                waterSplash.play(hitSound);
//            }
//        }
//        else if(cannonball.getDestinationGrid() == OPPONENTFIELD || !shipHit) {
